        ...
        <article class="tile is-child box homeChessbg">
          ...
          <div class="tile is-parent is-vertical">
            <article class="tile is-child">
              <p class="title learnTitle">Step 1: Setup, Turns, and Taking Pieces</p>
              <img src="assets/img/learn/learn01.png" class="learnimg"/>
              <p class="subtitle learnSubTitle">Setup:</p>
              ...
              <p class="subtitle learnSubTitle">Turns:</p>
              ...
              <p class="subtitle learnSubTitle">Taking Pieces:</p>
            ...
            <article class="tile is-child">
              <p class="title learnTitle">Step 2: Pawn Movement</p>
              <img src="assets/img/learn/learn02.png" class="learnimg"/>
              ...
              <p class="subtitle learnSubTitle">Pawn Promotion:</p>
            ...
            <article class="tile is-child">
              <p class="title learnTitle">Step 3: Rook</p>
              <img src="assets/img/learn/learn03.png" class="learnimg"/>
              <p>Rooks move in a continuous line forwards, backwards and side-to-side.</p>
            </article>
            <article class="tile is-child">
              <p class="title learnTitle">Step 4: Knight</p>
              <img src="assets/img/learn/learn04.png" class="learnimg"/>
            ...
            <article class="tile is-child">
              <p class="title learnTitle">Step 5: Bishop</p>
              <img src="assets/img/learn/learn05.png" class="learnimg"/>
              <p>Bishops move in continuous diagonal lines in any direction.</p>
            </article>
            <article class="tile is-child">
              <p class="title learnTitle">Step 6: Queen</p>
              <img src="assets/img/learn/learn06.png" class="learnimg"/>
              <p>The queen moves in continuous diagonal and straight lines. Forward, backward and side-to-side.</p>
            </article>
            <article class="tile is-child">
              <p class="title learnTitle">Step 7: King</p>
              <img src="assets/img/learn/learn07.png" class="learnimg"/>
            ...
            <article class="tile is-child">
              <p class="title learnTitle">Step 8: Special Move: Castling</p>
              <img src="assets/img/learn/learn08.png" class="learnimg"/>
              ...
              <p class="has-text-centered">A. If the king was in check, but is no longer.</p>
              <p class="has-text-centered">B. If the rook can be attacked by an opponent's piece before castling.</p>
            </article>
            <article class="tile is-child">
              <p class="title learnTitle">Step 9: Special Move: En Passant</p>
              <img src="assets/img/learn/learn09.png" class="learnimg"/>
            ...
            <article class="tile is-child">
              <p class="title learnTitle">Step 10: Check</p>
              <img src="assets/img/learn/learn10.png" class="learnimg"/>
            ...
            <article class="tile is-child">
              <p class="title learnTitle">Step 11: Checkmate</p>
              <img src="assets/img/learn/learn11.png" class="learnimg"/>
            ...
            <article class="tile is-child">
              <p class="title learnTitle">Step 12: Stalemate</p>
              <img src="assets/img/learn/learn12.png" class="learnimg"/>
            ...
            <article class="tile is-child">
              <p class="title learnTitle">Step 13: Basic Strategy</p>
              ...
              <p class="subtitle learnSubTitle">Piece Value:</p>
              ...
              <p class="subtitle learnSubTitle">Board Control:</p>
